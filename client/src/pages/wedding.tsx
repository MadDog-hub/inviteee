              ...
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                      <li>• Drag-and-drop guest assignment</li>
                      <li>• Visual table layout</li>
                      <li>• Track confirmed guests per table</li>
                      <li>• Built-in search to find guests instantly</li>
                      <li>• Update arrangements with one click</li>
                      <li>• Print-ready seating charts</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a 
                href="https://www.instagram.com/invit_eee/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-pink-600 px-8 py-4 rounded-full font-semibold text-lg transition-all inline-flex items-center gap-2"
