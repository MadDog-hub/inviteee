...
import { Heart, Cake, CheckCircle, Users, MessageSquare } from "lucide-react";
      ...
      <div className="container-width">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="demo-subtitle">
            Be the first to experience our smart event website system that creates stunning, personalized invitations for your special moments.
          </p>
        </div>
